...
public class MyStringBuilder
{
    ...
    public MyStringBuilder AppendFormat(IFormatProvider provider, CompositeFormat format, ReadOnlySpan<object> args)
    {
        _builder.AppendFormat(provider, format, args);
        return this;
    }
    ...
    public bool Equals(MyStringBuilder cb) => _builder.Equals(cb._builder);
